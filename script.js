...
let getPokeData = () => {
  // Remove the 'loaded' class to reset the fade-in effect
  cardContainer.classList.remove('loaded');
...
let generateCard = (data) => {
    ...
    pokeNameElement.addEventListener('mouseover', () => {
        pokeNameElement.style.color = themeColor;
    });
    pokeNameElement.addEventListener('mouseout', () => {
        pokeNameElement.style.color = ''; // Reset color on mouseout
    });
};
